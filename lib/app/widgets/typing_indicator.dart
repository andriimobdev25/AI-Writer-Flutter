...
class TypingIndicator extends StatefulWidget {
  const TypingIndicator({
    ...
    this.flashingCircleDarkColor = const Color.fromARGB(255, 71, 71, 71),
...
class CircleBubble extends StatelessWidget {
  const CircleBubble({super.key, required this.size, required this.bubbleColor});
...
class StatusBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(27), color: bubbleColor),
      child: Row(
